...
#define HZ 60
#define TESTING_FADE_DURATION_MSECS 10000
...
#define TRIAC_GATE_QUIESCE_CYCLES 1000
...
//     ESP_LOGI(LOG_STARTUP, "Configured wifi.\n");
    ...
    gpio_set_intr_type(ZERO_CROSSING_PIN, GPIO_INTR_NEGEDGE);
